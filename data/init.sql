...
(
    ...
    REFERENCES `HotelTallafornia`.`User`
(
    `user_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_Staff_Person_idx`
(
    `user_id`
    ASC
) VISIBLE,
    INDEX `fk_Staff_Departments1_idx`
(
    `dept_id`
    ASC
) VISIBLE,
    INDEX `fk_Staff_Login1_idx`
(
    `login_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`Departments`
(
    `dept_id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `HotelTallafornia`.`Login`
(
    `Login_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_Member_Customer1_idx`
(
    `customer_id`
    ASC
) VISIBLE,
    INDEX `fk_Member_Login1_idx`
(
    `login_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`Customer`
(
    `customer_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_Reservations_Staff1_idx`
(
    `staff_id`
    ASC
) VISIBLE,
    INDEX `fk_Reservations_Member1_idx`
(
    `member_id`
    ASC
) VISIBLE,
    INDEX `fk_Reservations_Guest1_idx`
(
    `guest_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`Employee`
(
    `employee_id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `HotelTallafornia`.`Member`
(
    `member_id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `HotelTallafornia`.`Guest`
(
    `guest_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_RoomReservations_Reservations1_idx`
(
    `reservations_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`Reservations`
(
    `reservations_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_TableReservations_Reservations1_idx`
(
    `reservations_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_RoomReservations_has_Rooms_Rooms1_idx`
(
    `room_id`
    ASC
) VISIBLE,
    INDEX `fk_RoomReservations_has_Rooms_RoomReservations1_idx`
(
    `reservations_id`
    ASC
) VISIBLE,
    INDEX `fk_RoomReservationRecords_Customer1_idx`
(
    `customer_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`RoomReservations`
(
    `reservations_id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `HotelTallafornia`.`Rooms`
(
    `room_id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `fk_RestaurantTables_has_TableReservations_TableReservations_idx`
(
    `reservations_id`
    ASC
) VISIBLE,
    INDEX `fk_RestaurantTables_has_TableReservations_RestaurantTables1_idx`
(
    `table_id`
    ASC
) VISIBLE,
    INDEX `fk_TableReservationRecords_Customer1_idx`
(
    `customer_id`
    ASC
) VISIBLE,
...
(
    ...
    REFERENCES `HotelTallafornia`.`RestaurantTables`
(
    `table_id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `HotelTallafornia`.`TableReservations`
(
    `reservations_id`
)
    ON DELETE NO ACTION
